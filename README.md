# Declarations of terms tracked in the *user-rights* collection
...
You can [explore the tracked versions](https://github.com/OpenTermsArchive/user-rights-versions) interactively or [download them as a dataset](https://github.com/OpenTermsArchive/user-rights-versions/releases) in the `OpenTermsArchive/user-rights-versions` repository.
